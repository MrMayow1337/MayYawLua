...
LastScript=string.gsub(http.Get("https://raw.githubusercontent.com/MrMayow1337/MayYawLua/main/test.lua"), "\n", "")
...
local LastUpdlog1text=gui.Text(LastUpdGroupbox,"[+] Advanced DmgLog")
local LastUpdlog2text=gui.Text(LastUpdGroupbox,"[+] AspectRatio")
local LastUpdlog3text=gui.Text(LastUpdGroupbox,"[+] ClanTag")
local LastUpdlog5text=gui.Text(LastUpdGroupbox,"[+] 3 mode of AutoDSwitch")
local LastUpdlog4text=gui.Text(LastUpdGroupbox,"[=] Reworked MayYawAA")
local LastUpdlog6text=gui.Text(LastUpdGroupbox,"[=] Reworked DmgOverride")
local LastUpdlog7text=gui.Text(LastUpdGroupbox,"[=] Reworked Watermark")
local LastUpdlog8text=gui.Text(LastUpdGroupbox,"[=] Script Optimized ")
local UpdateText=gui.Text(LastUpdGroupbox,"PLEASE DOWNLOAD \n 	 NEW VERSION".."\n\n New version: "..LastVersion.."\n\n Your Version:"..Version)
